...
Enter Shadow Zapdos.    <strong>Shadow Zapdos locks down the Azumarill matchup </strong>and also
    picks up Sunny Cherrim, Jirachi, Scrafty, Umbreon, and Venusaur—and
...
<p>
    ...
    to obtain. Instead, Elite TM’s allow you to navigate its dozens of moves to
...
<p>
    ...
    their collection. If you’re just entering the arena, you can use Elite TM’s
    to catch up. These moves may be available later via future Community Day
    events, special Raid events, or local trade partners, so only use Elite
    TM’s for these if you need them right now. The Community Day and Raid Day
    Pokemon below are top tier in the listed formats, so obtaining them could
    be well worth it:
</p>
<ul type="disc">
    <li>
...
<p>
    If you already have these in your collection, you’re good to go. There’s
another question worth asking:    <strong>what about Shadow Pokemon with their Community Day moves?</strong>
</p>
<p>
...
<p>
    Below are relevant Shadow Pokemon with their Community Day moves and notes
    about how they compare to their regular counterparts:
</p>
<ul type="disc">
    <li>
