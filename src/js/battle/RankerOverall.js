			...
			this.displayRankingData = function(){
				...
				for(var i = 0; i < rankings.length; i++){
					...
					*/
					...
					rankings[i].score = Math.pow( Math.pow(sortedScores[0], 9) * Math.pow(sortedScores[1], 7) * Math.pow(sortedScores[2], 6) * Math.pow(sortedScores[3], 2) * Math.pow(consistencyScore, 2), (1/26));
