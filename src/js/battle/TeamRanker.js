			...
			this.rank = function(team, league, cup, exclusionList){
				...
				if((targets.length == 0)||(cup.name != "custom")){
					...
					if(cup.name == "championships-1"){
						permaBannedList = permaBannedList.concat(["lugia","cresselia","deoxys","deoxys_attack","deoxys_defense","deoxys_speed","mew","celebi","latios","latias","uxie","mesprit","azelf","melmetal","celebi","zapdos","articuno","moltres","suicune","entei","raikou","regirock","registeel","regice","ho_oh"]);
					}
