    ...
    function createInstance() {
		...
		function rankerObject(){
			...
			this.rank = function(team, league, cup){
				...
				var bannedList = ["mewtwo","ho-oh","lugia","giratina_altered","groudon","kyogre","rayquaza","garchomp","latios","latias","palkia","dialga","heatran","regice","regirock","giratina_origin"];
