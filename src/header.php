...
<link rel="stylesheet" type="text/css" href="<?php echo $WEB_ROOT; ?>css/style.css?v=182">
...
<?php if(strpos($_SERVER['REQUEST_URI'], 'articles') !== false): ?>
	<link rel="stylesheet" type="text/css" href="<?php echo $WEB_ROOT; ?>css/article-extras.css?v=19">
<?php endif; ?>
	...
	<?php  if(false): // Removing this but saving code for future use ?>
		<?php if(strpos($_SERVER['REQUEST_URI'], 'world-of-wonders') == false): ?>
			<div class="header-ticker">
				<a href="https://pvpoke.com/world-of-wonders/rankings/">Preview next season</a>
			</div>
		<?php else: ?>
